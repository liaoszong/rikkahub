    ...
    Surface(
        ...
        Scaffold(
            ...
            ChatList(
                ...
                onToolApproval = { requestId, toolCallId, approved, reason ->
                    vm.handleToolApproval(requestId, toolCallId, approved, reason)
                },
                onToolAnswer = { requestId, toolCallId, answer ->
                    vm.handleToolAnswer(requestId, toolCallId, answer)
                },
